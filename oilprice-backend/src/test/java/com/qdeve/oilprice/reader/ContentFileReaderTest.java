...
public class ContentFileReaderTest
{
	...
	@Test
	public void shouldProperlyReadContentFromFile()
	{
		// given
		given(properties.getContentPath()).willReturn("file:src/test/resources/contentFile.txt");

		// when
		String content = readerUnderTest.get();

		// then
		assertThat(content, equalTo("let the force be with you"));
	}
